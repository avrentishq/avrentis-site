...
export const BRAND = {
  ...
  /**
   * Legal entity asserted in copyright/footer chrome. Placeholder pending
   * finalisation — keep in lockstep with `avrentis-app/src/lib/brand.ts`
   * (which is lock-tested); do not change here alone.
   */
