...
const FAQS = [
  ...
  },
  {
    ...
    a: "Today, the platform runs on managed infrastructure primarily hosted in the EU, with a global edge network in front. Dedicated in-country or in-region hosting is available on request as part of an enterprise engagement.",
  },
  {
