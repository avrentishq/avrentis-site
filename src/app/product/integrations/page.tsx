...
export const metadata: Metadata = {
  ...
  description:
    "Identity (SAML / OIDC / SCIM), notifications (email / WhatsApp / SMS), accounting (QuickBooks / Xero / SAP), banking, and a first-class developer platform. Every integration labelled honestly — available, coming 2026, or built on request.",
  openGraph: {
